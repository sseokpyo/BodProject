										...
										<div id="colorlib-main">
									    	...
									    	<div class="container">
                                                ...
                                                <div class="row" style="margin-bottom:5px;">
													<h3 style="padding:5px; color:#777; border-left:5px solid #B1C763; font-weight:500;">&nbsp;QnA</h3>
												</div>
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form action="qnaModify" method="post">
                                                        <input type="hidden" value="${qdto.qacode}" name="qacode">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">글제목</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="${qdto.qatitle}" id="qatitle" name="qatitle" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">작성자</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="${qdto.qamnick}" name="qamnick" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">글내용</label>
                                                                <div class="col-sm-10">
                                                                    <textarea rows="5" cols="5" class="form-control" id="qaq" name="qaq" disabled>${qdto.qaq}</textarea>
                                                                </div>
                                                                <div class="col-sm-12" style="float:left;">
                                                                <button class="groupBtn" style="width: 10%; height: 90%;" type="button" onclick="qnaModify()" id="modifybtn">수정</button>
                                                                <button class="groupBtn" style="display:none; width: 10%; height: 90%;" type="submit" id="modifysubmit">수정</button>
                                                                <button class="groupBtn" style="width: 10%; height: 90%;" type="button" onclick="location.href='qnaDelete?qacode=${qdto.qacode}'">삭제</button>
                                                            	</div>
                                                            </div>
                                                        </form>
                                               ...
                                               <!-- 답변작성칸 -->
                                                <div class="card">
                                                    <div class="card-block">
                                                        ...
                                                        <input type="hidden" name="qacode" value="${qdto.qacode}">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">답변내용</label>
                                                                <div class="col-sm-10">
                                                                    <textarea rows="5" cols="5" class="form-control" name="qaa"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
							                                	<div class="col-sm-12">
																	<button class="groupBtn" type="submit">답변작성</button>
																</div>                                                       
                                                            </div>
                                                        </form>
                                                        </c:if>
                                                    ...
                                                    <div class="card-block">
                                                        <form>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">답변내용</label>
                                                                <div class="col-sm-10">
                                                                    <textarea rows="5" cols="5" class="form-control" name="qaa">${qdto.qaa}</textarea>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
...
<script type="text/javascript">
	function qnaModify(){
		$("#qatitle").removeAttr("disabled");
		$("#qaq").removeAttr("disabled");
		$("#qatitle").focus();
		$("#modifybtn").remove();
		$("#modifysubmit").css("display", "");
	}
</script>
