...
function acceptFriend(friendId, userId){
	...
	location.href = 'acceptFriend?friendId=' + friendId + '&userId=' + userId;
}

function refuseFriend(friendId, userId){
	console.log('friendId / userId : ' + friendId + ' / ' + userId);
	location.href = 'refuseFriend?friendId=' + friendId + '&userId=' + userId;
}

function deleteFriend(friendId, userId){
	console.log('friendId / userId : ' + friendId + ' / ' + userId);
	location.href = 'deleteFriend?friendId=' + friendId + '&userId=' + userId;
}
</script>
