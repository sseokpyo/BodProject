									...
									<div class="row">
										<div class="col-lg-8">
											<div class="card">
												...
												<!-- 글쓰기 폼 사진 영역 -->
												<form action="boardModify" method="post" enctype="multipart/form-data" id="form">
												<div class="card-block" style="padding:0px;">
													<div class="form-group row">
														<div class="col-sm-12">
															<div class="swiper-container mySwiper">
														      <div class="swiper-wrapper">		
														  		<c:forEach items="${timeline.photo}" var="photo">
																        <div class="swiper-slide">
																          <div class="swiper-zoom-container">
																            <img style="width:100%; height:100%; object-fit:cover;"src="${pageContext.request.contextPath}/resources/uploadImg/${photo}" />
												...
												<div class="card-block">
													<div class="form-group row">
														<div class="col-sm-12">
															<textarea style="height: 400px; " class="form-control" id="textarea" name="bcontent" placeholder=" 문구 입력...">${timeline.bcontent}</textarea>
															<input type="hidden" name="bcode" value="${timeline.bcode}">
															
															<!-- 해시태그 -->
															<input type="hidden" name="taglist" id="tag" style="padding-left:10px;">
															<ul id="tag-list">
																<c:forEach items="${tagList}" var="tagList" varStatus="i">
																	<li class='tag-item'><span id="tag${i.index}">${tagList.tagname}</span><span class='del-btn' id="${i.index}">x</span></li>
																</c:forEach>
        													</ul>
													...
													<div class="form-group row">
														...
														<div class="col-sm-6">
															<button type="submit" class="groupBtn" style="width: 100%; height: auto;">수정완료</button>
														</div>
													</div>
												</div>
												</form>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#addtag").on("keypress", function (e) {
            ...
            if (e.key === "Enter" || e.keyCode == 32) {
                ...
                if (self.val() !== "") {
                    ...
                    // 태그 중복 검사
                    if (result.length == 0) { 
                        $("#tag-list").append("<li class='tag-item'>"+tagValue+"<span class='del-btn' id='"+counter+"'>x</span></li>");
                        addTag(tagValue);
                        self.val("");
                    } else {
                        alert("태그값이 중복됩니다.");
        ...
        $(document).on("click", ".del-btn", function (e) {
            ...
            var tagId = "#tag"+index;
            var tagName = $(tagId).text(); //해당 해시태그의 값
           	var tagCode = "${timeline.bcode}";
            $(this).parent().remove();
            
            //데이터베이스 해시태그 제거
            $.ajax({
            	type : "get",
            	url : "modifyBtagDelete",
