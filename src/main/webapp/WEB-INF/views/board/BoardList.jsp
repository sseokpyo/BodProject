...
<script src="https://kit.fontawesome.com/f3520ad06d.js"
																		...
																		<ul id="group_ul">
																			<li class="dropdown_group"
																				...
																				<div class="dropdown-content_group">
																					<c:choose>
						                                                               <c:when test="${boardList.bmid == sessionScope.loginId}">
						                                                                  <a href="moveBoardModifyForm?bcode=${boardList.bcode}">수정하기</a>
																	...
																	<div class="half order-md-last text-md-right">
																		<p class="meta" style="font-size: 20px;">
																			<i class="${boardList.likemodify}"
																				...
																				style="color: black;"></i>
																				<span id="updateboardlikecount${boardList.bcode}">${boardList.likecount}</span>
																			<i class="far fa-comment" style="color: black; margin-left:10px;"
																				id="boardcomment${boardList.bcode}"
																				onclick="showCommList('${boardList.bcode}')"></i>
																			<span id="updatecommcount${boardList.bcode}">${boardList.commcount}</span>
																		</p>
																	</div>
																</div>
															</div>
													...
													<div class="card-block" style="padding: 0px;">
														<div class="table-responsive" style="padding: 0px;">
															<form onsubmit="return comm(this);"
																...
																<input type="hidden" name="cbcode" value="${boardList.bcode}" id="fixnamecode${boardList.bcode}"> 
																<input type="hidden" name="cmid" value="${sessionScope.loginId}" id="fixnamemid${boardList.bcode}">
																<table class="table table-hover without-header" style="margin-bottom: 0px; width:100%;">
																	<thead>
																		<tr>
