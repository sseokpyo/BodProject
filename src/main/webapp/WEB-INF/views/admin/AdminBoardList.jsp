																...
																<table class="table" style="text-align: center;">
																		...
																		<c:forEach items="${board}" var="board">
																			<tr style="height: 50px; width: auto">																				
																				<td style="width: 15%;">${board.bmid}</td>
																				<td style="width: 15%;">${board.bdate }</td>
																				<td style="width: 55%;">${board.bcontent}</td>
																				<td><button class="groupBtn2" style="width: 100px;" onclick="boardView('${board.bcode}')">상세정보</td>
																				<td><button class="groupBtn2" style="width: 100px;" onclick="deleteBoard('${board.bcode}')">삭제</button></td>
																			</tr>
																		</c:forEach>
																</table>
															</div>
...
function boardView(bcode){
	console.log("boardView bcode : " + bcode);
	location.href = "boardView?bcode=" + bcode;
}
