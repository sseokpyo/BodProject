																...
																<table class="table" style="text-align: center;">
																		...
																		<c:forEach items="${groupList}" var="groupList">
																			<tr style="height: 100px; width: auto">																				
																				<td style="width: 15%;"><img class="img-radius" style="height: 70px; width: 70px;" alt="" src="${pageContext.request.contextPath}/resources/uploadImg/groupProfile/${groupList.gprofile}"></td>
																				<td style="width: 15%;">${groupList.gname}</td>
																				<td style="width: 30%;">${groupList.ginfo }</td>
																				<td style="width: 10%;">${groupList.gmanager }</td>
																				<td style="width: 10%;">${groupList.gusernum }</td>
																				<td style="width: 10%;"><button class="groupBtn2" style="width: 100px;" onclick="moveGroupPage('${groupList.gcode}')">이동</button></td>
																				<td style="width: 10%;"><button class="groupBtn2" style="width: 100px;" onclick="deleteGroup('${groupList.gcode}')">삭제</button></td>
																			</tr>
																		</c:forEach>
																</table>
															</div>
