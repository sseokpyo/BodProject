							...
							<section class="ftco-section">
								<div class="container">
									<div class="row">
									 ...
									 <div class="col-lg-8">
										<div class="row">
										<h3 style="padding:5px; color:#777; border-left:5px solid #95AECB; font-weight:500;">&nbsp;Group</h3>
										<button class="mofiBtn" style=" margin:10px 0px 0px 520px; float:right; disply:inline-box;
										width:120px; height:40px; background-color: #95AECB; color:white; font-weight:500;" 
										onclick="location.href='moveGroupCreateForm'">
										<i class="fas fa-plus"></i>&nbsp;그룹생성</button>	
									
										<div class="col-md-12" style=" height:80px;  background-color:white; margin-bottom:30px; width:100%">
										...
										<div id="groupListArea" style="width:100%">
										<c:forEach items="${groupPage}" var="group">
												...
												<img class='img-radius mCS_img_loaded ' src='${pageContext.request.contextPath}/resources/uploadImg/groupProfile/${group.gprofile};' 
													alt='User-Profile-Image' style='width:80px; height:80px; margin:15px;'>
												<div class='info' style='height:70px; width:400px;'>	
												<a href="#" onclick="moveGroupPage('${group.gcode}')"><span style='font-size:18px; font-weight:bold; color:#333333;'>${group.gname}</span></a>
												<span style='font-size:12px; margin-left:8px;' id='guserNum'>회원수 : ${group.gusernum}</span>
												<p style='font-size:14px; color:#4d4d4d;'>${group.ginfo}</p>
												</div>
												<button class='mofiBtn' style=' margin:0px 0px 10px 30px;'onclick="moveGroupPage('${group.gcode}')">페이지로 이동</button>
												</div>
												</div>
										</c:forEach>
