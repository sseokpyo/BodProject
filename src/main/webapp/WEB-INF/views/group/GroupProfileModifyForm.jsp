						...
						<div id="colorlib-main">
							<section class="ftco-section">
								<div class="container" >
									...
									<h3 style="padding:5px; color:#777; border-left:5px solid #80A1C2; font-weight:500; font-family: 'InfinitySans-RegularA1';">&nbsp;그룹 프로필 수정</h3>
									</div>
									<div class="row">
                                    ...
                                    <div class="col-sm-12">
                                		<div class="form-group form-primary">
                                			<span style="font-size:14px;">그룹 소개</span>
						...
						success : function(checkResult){
							...
							if(checkResult == null){
								...
								if(checkResult == gname){
									$("#checkGnameMsg").text("*변경전 그룹명 입니다.").css("color", "green");
									modifyGname = "OK";
								}else{
